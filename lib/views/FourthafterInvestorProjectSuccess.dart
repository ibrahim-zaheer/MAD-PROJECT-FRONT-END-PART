...
class FourthadterInvestorProjectSuccess extends StatefulWidget {
  ...
  final String Bio;
  FourthadterInvestorProjectSuccess(
  ...
  @override
  State<FourthadterInvestorProjectSuccess> createState() =>
      _FourthadterInvestorProjectSuccessState();
}

class _FourthadterInvestorProjectSuccessState
    extends State<FourthadterInvestorProjectSuccess> {
  @override
